...
def plot_decision_surface_cnb(X, y, classifier, classes, attribute1_index, attribute2_index, title=''):
...
def run(X,y,colunas,classes):
	...
	plot_decision_surface_cnb(X_train_selected, y_train, classifier, colunas, classes, attribute1_index, attribute2_index, title='Decision Surface for Naive Bayes Classifier')
